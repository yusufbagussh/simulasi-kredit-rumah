        ...
        <div class="container">
            ...
            <form action="output.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <button class="btn btn-lg btn-primary" name="gass">Kalkulasi</button>
                </div>
                <footer>
